...
switch(Settings.phase{1})
    ...
    case 'Post-scan'
        ...
        fprintf(fileID,['Item Recall data file for %d at %s\n'...
            'Trial\tSequence Ref\tPosition\tImage Ref\tChoice\tCorrect\tRT\tTrial Type\n'],Settings.SubID,datestr(now));
        ...
        for n=1:length(test_order)
            ...
            fprintf(fileID,'%d\t%d\t%d\t%d\t%d\t%d\t%.3f\t%d\n',...
                n,theData.image_test(n).seq_ref,theData.image_test(n).seq_image_ref,theData.image_test(n).image_ref,...
                theData.image_test(n).image_choice,theData.image_test(n).image_correct,theData.image_test(n).image_times,...
                theData.image_test(n).seq_type);
