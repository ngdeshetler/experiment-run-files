function RunSeq_itemO(varargin)
%% SETUP

commandwindow; % bring focus to command window.

script_path=which('RunSeq_itemO.m');
...
while strcmp(Settings.phase,'Demo')
    ...
    switch runn
        case 'Rerun'
            RunSeq_itemO('settings',Settings,'phase','Demo');
        case 'Move on'
            RunSeq_itemO('settings',Settings,'phase','PreScan');
        case 'Quit'
...
switch(Settings.phase{1})
    ...
    case 'PreScan'
        ...
        switch runn
            case 'Move on'
                RunSeq_itemO('settings',Settings,'phase','Scan Demo');
            case 'Quit'
                Settings.phase{1}='Quit';
        end
        toc
    ...
    case 'Scan Demo'
        ...
        switch runn
            case 'Move on - w/ Trigger'
                RunSeq_itemO('settings',Settings,'phase','N-Back','scan','Yes');
            case 'Move on - w/o Trigger'
                RunSeq_itemO('settings',Settings,'phase','N-Back');
            case 'Quit'
                Settings.phase{1}='Quit';
        end
        %%
    case 'N-Back'
        ...
        switch runn
            case 'Move on'
                RunSeq_itemO('settings',Settings,'phase','Scan');
            case 'Quit'
                Settings.phase{1}='Quit';
        end
    ...
    case 'Scan'
        ...
        switch runn
            case 'Move on'
                RunSeq_itemO('settings',Settings,'phase','Post-scan','scan','No');
            case 'Quit'
                Settings.phase{1}='Quit';
        end
